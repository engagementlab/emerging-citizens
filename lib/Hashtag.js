...
module.exports = function(gameSession) {
    ...
    function CalcPlayerScore(playerId, real) {
        console.log (playerId + " is the player who is getting points");
    ...
    this.HashtagVote = function(playerId, hashtag, socket) {
        console.log (hashtag);
        var submitterId = [];
        thisHashtag = _.pick(_CURRENT_SUBMISSIONS, hashtag);
        console.log(JSON.stringify(thisHashtag) + " is the hashtag");
        for (var item of (_.values(_.pick(_CURRENT_SUBMISSIONS, hashtag)))[0]) {
            console.log(JSON.stringify(item) + " is an item");
            submitterId.push(item);
        }
        
        
        console.log (JSON.stringify(submitterId) + " submitted that hashtag!")
        var voteScore = 0;

        for (var submitter of submitterId) {
            console.log (JSON.stringify(submitter) + " is a submitter");
        ...
        _CURRENT_SUBMISSIONS[hashtag] = thisHashtag[hashtag];
        _VOTES++;
        console.log (JSON.stringify(_CURRENT_SUBMISSIONS) + " are the current submissions");
