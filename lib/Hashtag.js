...
module.exports = function(gameSession) {
    ...
    function StartVoting(socket) {
        ...
        // var groupedByHashtag = _.groupBy(randomizedHashtags, function(item, key, hashtag) {
        //     return item.hashtag;
        // });
        // console.log (groupedByHashtag);
        // var duplicates = [];
        // for (var hashtag in groupedByHashtag) {
        //     if (groupedByHashtag[hashtag] > 1) {
        //         _.where(randomizedHashtags, {
        //             hashtag: hashtag
        //         }).map(function(item){
        ...
        // console.log (_CURRENT_SUBMISSIONS.length + " is # of hashtags");
        // console.log (uniqueHashtags.length + " is # of uniq hashtags");
        // //check if any duplicates were removed 
        // if (uniqueHashtags.length < _CURRENT_SUBMISSIONS.length) {
        //     uniqueHashtags.push({ id: duplicateId, hashtag: Sentencer.make('{{noun}}'), username: _PLAYERS[playerId].username });
        //     console.log (uniqueHashtags);
        // }
        var data = {
    ...
    this.HashtagSubmitted = function(player, submission, socket, space) {
        ...
        console.log (JSON.stringify(_CURRENT_SUBMISSIONS) + " are the updated, current submissions");
        ...
        _PLAYERS_SUBMITTED = _.values(_CURRENT_SUBMISSIONS);
        ...
        // }
        // var uniqPlayers = _.uniq(_PLAYERS_SUBMITTED, function (item) {
        //     return item;
        // });
        console.log(JSON.stringify(_PLAYERS_SUBMITTED) + " are the id's for the players");
        console.info(_PLAYERS_SUBMITTED.length + ' players out of ' + currentPlayerCap + ' have submitted.');
