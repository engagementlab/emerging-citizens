...
module.exports = function(gameSession) {
    ...
    function StartVoting(socket) {
        ...
        var randomizedHashtags = _.pairs(_CURRENT_SUBMISSIONS);
    ...
    this.HashtagVote = function(playerId, submitterId, socket) {
        ...
        for (var item of hashtagSubmissions) {
            i++;
            console.log (JSON.stringify(item) + " is item #" + i);
            console.log (JSON.stringify(item[1]) + " is the player for item #" + i);
            for (var player of item[1]){
                console.log (JSON.stringify(player) + " is one of the players for item #" + i);
                var thisHashtag = _.where(player, {id: submitterId})[0];
            }
            // var hashtagItem = 
        ...
        console.log (thisHashtag + " is the hashtag");
        var voteScore = 0;
