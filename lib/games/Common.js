...
class Common {
    ...
    Countdown(socket) {
        ...
        // console.log (this._config.timeLimitWiki, "time limit set");
        // console.log (this._game_session.gameType, "the game type");
        var timeLeft;
        // this._event_countdown_done = callback;
        ...
        this._countdown = setInterval(() => {
            ...
            if(timeLeft === 0) {
                ...
                clearInterval(this._countdown);
                this.eventEmitter.emit ('countdownEnded');
                // callback(args);
