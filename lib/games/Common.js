...
class Common {
    ...
    constructor() {
        ...
        // Duration to wait for player to refresh client before timing her out
    ...
    PlayerRemove(player) {
        ...
        if (!player.connected) {
            ...
            this._group_socket.to(this.group_id).emit('players:update', {players: _.sortBy(this._current_players, function(player) {return player.index}), state: 'lost_player'});
