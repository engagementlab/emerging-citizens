...
class HashtagLib extends Core {
    ...
    AdvanceRound(socket) {
        ...
        console.log(this._current_round, "advancing round", this._config.roundNumber);
    ...
    StartVoting(socket) {
        ...
        this.Templates.Load('partials/group/htyi/voting', data, (html) => {
            ...
            this.Countdown(socket, "votingCountdown");
    ...
    ShowSubmissions(socket) {
        ...
        let playerData = {
                            last_round: lastRound, 
                            survey: this._config.surveyHashtag, 
                            surveyUrl: this._config.surveyUrlHashtag
                        };
    ...
    HashtagSubmitted(playerSocketId, submission, socket, space) {
        ...
        console.log(this._players_submitted.length + ' players out of ' + this._current_player_cap + ' have submitted.', '('+this._game_session.accessCode+')');
