...
class WikiLib extends Common {
    ...
    DisplayResults(force) {
        ...
        let loadPlayerResults = (data, playerId) => {
            ...
            if(lastRound) {
                data.survey = this._config.surveyHashtag;
                data.surveyUrl = this._config.surveyUrlHashtag;
            }
    ...
    PlayerClick(playerSocketId, articleTitle, initialSearch) {
        ...
        // console.log(thisPlayer, " done be clickin")
        ...
        if(playerSubmission === this.allArticles[this._current_round].articleName) {
            ...
            thisPlayerProgress.scores[1] = (this._config.scorePlacementWiki * ((this._current_player_cap + 1) - this.playerFinishedCt));
