...
class WikiLib extends Common {
    ...
    DisplayArticle() {
        ...
        var playerCount = _.keys(this._current_players).length;

        console.log (playerCount, "versus", this._players_submitted.length)

        // random starting article for players who never submitted
        if (playerCount > this._players_submitted.length) {
    ...
    PlayerClick(playerSocket, articleTitle, initialSearch) {
        ...
        console.log ("there dun be a player click");
        ...
        if(initialSearch) {
            ...
            console.log (thisPlayer, "the player kay");
            ...
            if(this._players_submitted.length === this.currentPlayerCap) {
                ...
                this.Countdown(playerSocket, {timeLimit: 5, countdownName: 'articleReveal'});
