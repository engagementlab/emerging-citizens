...
class WikiLib extends Core {
    ...
    DisplayResults(force) {
        ...
        let loadPlayerResults = (data, playerId) => {
            ...
            if(lastRound) {
                console.log("this is the last round so lets do this data")
        ...
        for(var playerId in progress) {
            ...
            if(thisPlayerProgress.articles.length > 24) {
                thisPlayerProgress.articles[23] = "....";
            ...
            for(var ind in thisPlayerProgress.articles) {
                ...
                thisPlayerProgress.articles[ind] = {display_index: i, title: thisPlayerProgress.articles[ind]};
            }
    ...
    PlayerClick(playerSocketId, articleTitle, initialSearch) {
        ...
        if(playerSubmission === this.allArticles[this._current_round].articleName) {
            ...
            // Articles expected as objects
            for(var ind in thisPlayerProgress.articles) 
                thisPlayerProgress.articles[ind] = {title: thisPlayerProgress.articles[ind]};
            
            // Load results view for player
            if(lastRound) {
                console.log("player got to the article AND this is the last round so lets do this data")
